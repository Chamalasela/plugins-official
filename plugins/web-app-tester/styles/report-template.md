...
**Plan Source:** {auto-generated by web-app-tester | found in PR description | sourced from acceptance criteria | sourced from bug repro steps}
...
`Plan Source` must be one of the four exact values above, set by `gather-test-context`. It tells reviewers how much confidence to place in the test plan's coverage.
