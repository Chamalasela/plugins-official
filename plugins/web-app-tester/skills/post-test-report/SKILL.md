...
| `PLAN_SOURCE` | gather-test-context | How the test plan was obtained — one of: `auto-generated by web-app-tester`, `found in PR description`, `sourced from acceptance criteria`, `sourced from bug repro steps` |
